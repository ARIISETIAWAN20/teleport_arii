...
-- 🔎 Deep Scan Hidden Admin/Observer
RunService.RenderStepped:Connect(function()
    for _, desc in ipairs(workspace:GetDescendants()) do
        if desc:IsA("BillboardGui") or desc:IsA("SelectionBox") or desc:IsA("Highlight") then
            if desc.Adornee and not desc:IsDescendantOf(player.Character) then
