-- ✅ Teleport GUI "Arii" - Final (Teleport Cepat, UI Rapi, Auto Save, Proteksi Lengkap)
...
createSlider("⏩ Delay Speed Point 1 (1-10)", teleportPoints.speed1, function(v)
    teleportPoints.speed1 = v
end)
createSlider("⏩ Delay Speed Point 2 (1-10)", teleportPoints.speed2, function(v)
